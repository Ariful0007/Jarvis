...
import static com.example.jarvis.Functions.string;
        ...
        text=new TextToSpeech(MainActivity.this, new TextToSpeech.OnInitListener() {
            ...
            public void onInit(int status) {
                if (text.getEngines().size()==0) {
                    Toast.makeText(MainActivity.this, "Not Found Engine", Toast.LENGTH_SHORT).show();
                }
                else {
                    String wish=string();
                    speck("Hi,i am jarvis sir.How Can i help you?.."+wish);
                }
            ...
            speechRecognizer.setRecognitionListener(new RecognitionListener() {
                ...
                public void onResults(Bundle results)
                {
                    ...
                    if (stringArrayList !=null) {
                        ...
                        Toast.makeText(MainActivity.this, "Result :"+kipper, Toast.LENGTH_LONG).show();
                    }
                    else {
                        Toast.makeText(MainActivity.this, "Speack Again..", Toast.LENGTH_SHORT).show();
                    }
